...
$router->group(['middleware' => 'auth'], function () use ($router) {
    ...
    $router->post('/getStoresWithThisBook','BookController@getStoresWithThisBook');
    $router->post('/getBookComments','BookController@getBookComments');
   ...
   // $router->post('/editUserFavoriteData','UserFavoriteDataController@editUserFavoriteData');
    ...
    $router->post('/getOrderData','OrderController@getOrderData');
    $router->post('/getOrderItemData','OrderController@getOrderItemData');
